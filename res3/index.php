...
$page_title = 'Welcome to KU Resturant Web site!';
               ...
               <div class="border-left">
               	<div class="border-right">
                  	<div class="inner">
                        ...
                        <h3><small>Welcome to KU Resturant!</small></h3>
                        <p>KU Resturant is the largest casual dining chain in the world, with locations throughout the U.S. and many countries worldwide. We take pride in having a friendly, welcoming, neighborhood environment for both <br>
                        our staff and guests that makes everyone enjoy their KUs experience.<p>If you're looking for a fabulous career with a great social environment, apply to become part of the KU's family. Hand-cut steaks, award winning ribs, fresh-baked bread and made from scratch side items are the standard at Texas Roadhouse. </p>
                        ...
                        <p>At KUls Resturant, our team has an incredible sense of pride in everything we do. We want our guests to have such a good time they'll want to come back again tomorrow.</p>
                        <p>&nbsp;	</p>                                               
                        <p><a href="index.php">Home</a>, <a href="about.php">About us</a>, <a href="menu.php">Menu</a>, <a href="contact.php">Contact us</a>, <a href="sitemap.php">Site Map</a>.
                      </div>
                     </div>
                  </div>
               </div>
